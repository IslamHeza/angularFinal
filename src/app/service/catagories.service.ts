...
export class CatagoriesService {
 ...
 worker:Workers[]=[
     ...
     new Workers(5,"Ahmed salem","assets/imges/p2.jpg","Cairo" ,"ddddd",5),
     new Workers(6,"mohamed Atef","assets/imges/p2.jpg","cairo" ,"ddddd",3),
     new Workers(7,"nadia Ebrahiem","assets/imges/p1.jpg","Mansoura" ,"ddddd",2),
